...
module.exports = function(app) {
    ...
    app.get('/rest/results', async function(req, res) {
        ...
        const filepath =  "./uploads/data_test.csv";
        const disease = "epileptic seizure";
    ...
    app.post('/rest/testing/datasets/upload', function(req, res) {
        ...
        const return_result = 'successful upload';
