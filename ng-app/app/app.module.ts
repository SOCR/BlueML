...
@NgModule({
    ...
    declarations: [ AppComponent,FileSelectDirective,  NavbarComponent, homeComponent, trainingDataComponent, uploadDataComponent, analysisComponent, resultComponent ],
