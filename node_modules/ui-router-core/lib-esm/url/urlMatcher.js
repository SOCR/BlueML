 ...
 * @module url
 */ /** for typedoc */
import { map, defaults, inherit, identity, unnest, tail, find, pairs, allTrueR, unnestR, arrayTuples } from "../common/common";
...
var UrlMatcher = (function () {
    ...
    UrlMatcher.compare = function (a, b) {
        ...
        var pairs = arrayTuples(aSegments.map(weight), bSegments.map(weight));
        // console.table(pairs);
